...
export default {
  ...
  theme: {
    ...
    fontSize: {
      'text-7xl': ['96px', { lineHeight: '90px', letterSpacing: '-0.02em' }],
      'text-6xl': ['76px', { lineHeight: '72px', letterSpacing: '-0.02em' }],
      'text-5xl': ['48px', { lineHeight: '60px' }],
      'text-4xl': ['36px', { lineHeight: '44px' }],
      'text-3xl': ['30px', { lineHeight: '38px' }],
